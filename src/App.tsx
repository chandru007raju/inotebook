    ...
    <> <div className="container">
      ...
      <Container className="card">
        ...
        <Stack className="justify-content-start ">
          <h5>S R Chandra Shekar</h5>
          <Stack className="ml-5" direction="horizontal"  > <a target={"_blank"} rel="noreferrer" href="https://www.linkedin.com/in/sr-chandra-shekar007">
            <img className="Link" src="../linkedin.png" alt="Linkedin" />
          </a>
          <a target={"_blank"} rel="noreferrer"  href="https://github.com/chandru007raju">
            <img className="link2" src="../github.png" alt="github" />
          </a>
          <a target={"_blank"} rel="noreferrer" href="https://www.instagram.com/sr.chandrashekar/">
